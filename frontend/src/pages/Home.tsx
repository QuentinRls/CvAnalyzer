      ...
      <div className="bg-gradient-to-r from-[#F8485D] to-[#e63946]">
        <div className="container mx-auto px-4 py-16 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            <BlurText text={"Prêt à analyser votre CV ?"} className="inline-block" delay={2.4} duration={1.2} stagger={0.02} />
          </h2>
          <p className="text-red-100 text-lg mb-8 max-w-2xl mx-auto">
            <BlurText text={"Rejoignez les professionnels qui optimisent leurs candidatures"} className="inline-block" delay={2.4} duration={1.2} stagger={0.02} />
            <BlurText text={"avec une analyse détaillée de leurs compétences."} className="inline-block" delay={3.4} duration={1.2} stagger={0.02} />
          </p>
